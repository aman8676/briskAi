          ...
          >
            ...
            <div className="relative z-10">
              <div className="inline-flex items-center gap-2 px-3 py-1 rounded-full text-xs font-semibold tracking-wider uppercase border border-indigo-400/30 bg-indigo-500/10 text-indigo-300">
                <Sparkles className="w-3.5 h-3.5" />◈ RAG STUDIO
              </div>
              ...
              <p
                className={`mt-3 text-sm leading-relaxed ${isDark ? "text-slate-300" : "text-indigo-100"}`}
              >
                Connect Google Gemini embeddings, PostgreSQL vectors,
                CrossEncoders, and Groq LLMs to audit chunk precision and
